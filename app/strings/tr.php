...
$strings = [
    'homePage' => 'Ana Sayfa',
    'createQuiz' => 'Kendi Testini Oluştur',
    'shareQuiz' => 'Testini Sevdiklerinle Paylaş',
    'blog' => 'Blog',
    'contact' => 'İletişim',
    'about' => 'Hakkında',
    ...
    'cookieWarning' => '<p>Web sitemizde size en iyi deneyimi sunabilmemiz için çerezleri kullanıyoruz.<br />Bu mesajı kapatarak, devre dışı bırakmadığınız sürece bu cihazdaki çerezlerimize izin vermiş olursunuz. Ayrıntılı bilgi için <a href="https://quizofmine.com/privacy-policy">Gizlilik Politikası</a> sayfasına göz atabilirsiniz.</p>',
    'cookieAccept' => 'Kabul Et',
    'quizYourMate' => 'Sevdiklerini Test Et',
    'homeSection1' => 'Sevdiklerin Seni Ne Kadar Tanıyor?',
    'homeSection1Text' => 'Soruları cevapla, linki sevdiklerine gönder, seni gerçekten tanıyıp tanımadıklarını öğren! Bunları yaparken herhangi bir spam reklamla karşılaşmayacağına ve verilerinin sen istemediğin sürece işlenmeyeceğine söz veriyoruz.',
    'startButton' => 'Hemen Başla!',
    'step1' => 'Soruları Belirle',
    'step1Text' => 'Soruları belirleyin ve cevaplayın.',
    'step2' => 'Linki Paylaş',
    'step2Text' => 'Test linkini sevdiklerinle paylaş.',
    'step3' => 'Sonuçları Gör',
    'step3Text' => 'Sevdiklerinin test sonuçlarını görüntüle.',
    'homeSection2' => 'Samimiyetinizi Test Etmenin En Eğlenceli Yolu!',
    'homeSection2Text' => 'Sevdiklerin seni gerçekten tanıyor mu? Senin nelerden hoşlandığınızı biliyorlar mı? Web sitemiz üzerinden yapacağın 3 kolay adımda sevdiklerinin seni ne kadar tanıdığını kolayca öğrenebilirsin.',
    'homeSection2.Step1' => '10 rastgele soru seçerek bir test oluşturun ve soruları kendinize göre cevaplayın.',
    'homeSection2.Step2' => 'Testin linkini sevdiklerinizle paylaşın.',
    'homeSection2.Step3' => 'Test sonuçlarını bir sayfadan görüntüleyin.',
    'noQuestionsFound' => 'Bu dil seçeneği için test oluşturma aktif değildir!',
    'footerInfo' => 'Bilgilendirme',
    'footerInfoText' => 'Bu web sitesindeki testler sadece eğlence amaçlı hazırlanmıştır. Hazırlanan testlerin herhangi bir şekilde geçerliliği yoktur.',
    'footerLinks' => 'Linkler',
    'footerPages' => 'Sayfalar',
    'quizPage' => 'Sevdiklerin Seni Ne Kadar Tanıyor?',
    'quizPageText' => 'Adını veya lakabını gir ve kendin hakkında soruları yanıtla. Ardından senin için oluşturulacak linki sevdiklerinle paylaşayarak seni ne kadar iyi tanıdıklarını test et.',
    'sharePageText' => 'Aşağıdaki linki sevdiklerinle paylaşarak onların teste katılmalarını ve seni ne kadar tanıdıklarını öğrenmelerini sağlayabilirsin.',
    'copyLink' => 'Linki Kopyala',
    'close' => 'Kapat',
    'linkCopied' => 'Link Kopyalandı!',
    'linkCopiedText' => 'Test linki panoya kopyalanmıştır!',
    'enterYourName' => 'Adınızı girin.',
    'createQuizButton' => 'Test Oluştur',
    'changeQuestion' => 'Soruyu Değiştir',
    'pleaseWaitText' => 'Cevaplarınız kaydediliyor, lütfen bekleyin...',
    'shareFacebook' => 'Facebook\'ta Paylaş',
    'shareWhatsapp' => 'WhatsApp ile Paylaş',
    'shareMessenger' => 'Messenger ile Paylaş',
    'shareTwitter' => 'Twitter\'da Paylaş',
    'shareLine' => 'Line ile Paylaş',
    'shareTelegram' => 'Telegram ile Paylaş',
    'showResults' => 'Sonuçları Görüntüle',
    'shareText' => 'Beni gerçekten tanıyor musun? Testi cevapla ve beni ne kadar tanıdığını öğrenelim.',
    'friendQuiz' => 'Onu Ne Kadar Tanıyorsun?',
    'friendQuizTest' => '%s\'ı Ne Kadar Tanıyorsun?',
    'friendQuizText' => '%s senin için terletici bir test hazırladı! Bu testi cevaplayarak onu gerçekten tanıyor musun öğren!',
    'friendKnow' => 'Sevdiklerin Seni Ne Kadar Tanıyor?',
    'friendKnowText' => 'Bu sayfanın linkini sevdiklerinle paylaş. Sevdiklerin testi çözdüklerinde puanları skor tablosunda gözükecek!',
    'doQuiz' => 'Testi Yap',
    'scoreTable' => 'Skor Tablosu',
    'scoreName' => 'Ad',
    'score' => 'Puan',
    'scoreEmpty' => 'Bu test daha önce hiç çözülmemiş.',
    'yourScore' => 'Skorunuz',
    'contactPageText' => 'Herhangi bir konuda bizimle iletişime geçmek isterseniz bu form aracılığı ile mesajınızı iletebilirsiniz.',
    'formNameText' => 'Adınızı girin.',
    'formEmailText' => 'E-Posta adresinizi girin.',
    'formSubjectText' => 'Mesaj konusunu girin.',
    'formMessageText' => 'Mesaj içeriğini girin.',
    'submit' => 'Gönder',
    'error' => 'Hata',
    'readMore' => 'Devamını Oku',
    'noBlogsFound' => 'Hiç blog yazısı yazılmamış!',
    'randomPosts' => 'Rastgele Yazılar',
    'fillAllFields' => 'Lütfen tüm alanları geçerli bir şekilde doldurun!',
    'recaptchaFailed' => 'Robot doğrulaması başarısız!',
    'messageSent' => 'Mesaj Gönderildi!',
    'messageSentText' => 'Mesajınız gönderilmiştir, en kısa sürede tarafınıza e-posta yoluyla dönüş yapılacaktır.',
    'unknownError' => 'Bilinmeyen bir hata oluştu!',
    'login' => 'Giriş Yap',
    'loginToPanel' => 'Yönetici Paneline Giriş Yap',
    'enterUsername' => 'Kullanıcı adınızı girin.',
    'enterPassword' => 'Parolanızı girin.',
    'loginSuccess' => 'Giriş başarılı, yönlendiriliyorsunuz...',
    'loginFailed' => 'Giriş başarısız!',
    'loginText' => 'Yönetici paneline erişmek için giriş yapmanız gereklidir.',    
    ...
    'profileSettings' => 'Yönetici Profili',
    'addPage' => 'Sayfa Ekle',
    'editPage' => 'Sayfayı Düzenle',
    'deletePage' => 'Sayfayı Sil',
    'addBlog' => 'Blog Yazısı Ekle',
    'editBlog' => 'Yazıyı Düzenle',
    'deleteBlog' => 'Yazıyı Sil',
    ...
    'questionAnswers' => 'Soru Cevapları',
    'answerText' => 'Cevap Metni',
    'answerImage' => 'Cevap Görseli (zorunlu değil)',
    'addAnswer' => 'Cevap Ekle',
    'enterAnswerText' => 'Cevap metnini girin.',
    'editQuestionInfo' => 'Bilgi: Soruyu düzenlediğiniz zaman daha önceden eklediğiniz görseller silinecektir. Bundan dolayı tekrar seçmeniz gerekmektedir.',
    'pageTitle' => 'Sayfa Başlığı',
    'pageContent' => 'Sayfa İçeriği',
    'pageMetaDesc' => 'Sayfa Meta Açıklaması',
    'pageMetaTags' => 'Sayfa Meta Anahtar Kelimeleri',
    'addFooterLink' => 'Sayfa Linki Footer Linkler Listesine Eklensin Mi?',
    'postTitle' => 'Yazı Başlığı',
    'postDate' => 'Yazı Tarihi',
    'postContent' => 'Yazı İçeriği',
    'postMetaDesc' => 'Yazı Meta Açıklaması',
    'postMetaTags' => 'Yazı Meta Anahtar Kelimeleri',
    'postImage' => 'Yazı Görseli',
    'messageSender' => 'Mesajı Gönderen',
    ...
    'yes' => 'Evet',
    'no' => 'Hayır',
    'totalQuizCount' => 'Toplam Test',
    'totalQuizAnswersCount' => 'Toplam Test Yanıtı',
    'applicationVersion' => 'Yazılım Versiyonu',
    'last10DaysStats' => 'Son 10 Günlük Yeni Test Sayısı Grafiği',
    'addQuestionSuccess' => 'Soru başarıyla eklendi!',
    'editQuestionSuccess' => 'Soru başarıyla düzenlendi!',
    'deleteQuestionSuccess' => 'Soru başarıyla silindi!',
    'addPageSuccess' => 'Sayfa başarıyla eklendi!',
    'editPageSuccess' => 'Sayfa başarıyla düzenlendi!',
    'deletePageSuccess' => 'Sayfa başarıyla silindi!',
    'addBlogSuccess' => 'Blog yazısı başarıyla eklendi!',
    'editBlogSuccess' => 'Blog yazısı başarıyla düzenlendi!',
    'deleteBlogSuccess' => 'Blog yazısı başarıyla silindi!',
    'deleteContactMessageSuccess' => 'İletişim mesajı başarıyla silindi!',
    'settingsSavedSuccess' => 'Ayarlar başarıyla kaydedildi!',
    'keepEmptyText' => 'Eğer değiştirmek istemiyorsanız boş bırakın.',
    'currentLogo' => 'Şu anki Logo',
    'newLogo' => 'Yeni Logo',
    'currentFavicon' => 'Şu anki Favicon',
    'newFavicon' => 'Yeni Favicon',
    'footerLinks' => 'Footer Linkleri',
    'buttonFooterLink' => 'Yeni Link Ekle',
    'linkTitle' => 'Link Başlığı',
    'linkUrl' => 'Link Adresi',
    'enterlinkTitle' => 'Link başlığını girin.',
    'enterlinkUrl' => 'Link adresini girin.',
    'siteTitle' => 'Site Başlığı',
    'siteDescription' => 'Site Meta Açıklaması',
    'siteTags' => 'Site Meta Etiketleri',
    'siteTimezone' => 'Site Zaman Dilimi', 
    'siteLanguage' => 'Site Dili',
    'questionLimit' => 'Soru Limiti',
    'recaptchaSiteKey' => 'ReCaptcha Site Anahtarı (v2 - Onay Kutusu)',
    'recaptchaSecretKey' => 'ReCaptcha Gizli Anahtar (v2 - Onay Kutusu)',
    'disqusUsername' => 'Disqus Kullanıcı Adı',
    'extraHeaderCode' => 'Ekstra Header Kodu',
    'extraFooterCode' => 'Ekstra Footer Kodu',
    'sidebarAdCode' => 'Sidebar Reklam Kodu',
    'inPostAdCode' => 'Yazı İçi Reklam Kodu',
    'scoreAdCode' => 'Skor Sayfası Reklam Kodu',
    'adminUsername' => 'Yönetici Kullanıcı Adı',
    'adminPassword' => 'Yönetici Parolası',
    'pageNotFound' => 'Sayfa Bulunamadı!',
    'pageNotFoundText' => 'Ulaşmaya çalıştığınız sayfa bulunamadı. Alttaki buton aracılığı ile ana sayfaya dönebilirsiniz.',
    'backToHome' => 'Ana Sayfaya Dön',
    'announcementBox' => 'Duyuru Panosu',
    'allRightsReserved' => 'Tüm Hakları Saklıdır',
    'cookieAcceptv1' => 'Kabul Et',
    'cookieNoticev1' => '<p>Web sitemizde size en iyi deneyimi sunabilmemiz için çerezleri kullanıyoruz.<br />Bu mesajı kapatarak, devre dışı bırakmadığınız sürece bu cihazdaki çerezlerimize izin vermiş olursunuz. Ayrıntılı bilgi için <a href="https://quizofmine.com/privacy-policy">Gizlilik Politikası</a> sayfasına göz atabilirsiniz.</p>',
    'privacyPolicy-content' => '<p>Son güncellenme: 30/10/2022</p>
    <p>
    Güvenliğiniz bizim için önemli. Bu sebeple bizimle paylaşacağınız kişisel verileriz hassasiyetle korunmaktadır.
    </p>
    <p>
    Biz, MADD, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin korunması politikası ile,
    ...
    <p>Yukarıda sayılan haklarınızı kullanmak üzere info@quizofmine.com üzerinden bizimle iletişime geçebilirsiniz.</p>
    <h3>İletişim</h3>
    <p>
    ...
    varsayılacak olup, daha ayrıntılı bilgi için bizimle info@quizofmine.com e-mail adresi üzerinden iletişime
    geçmekten lütfen çekinmeyiniz.
    </p>',
    'about-content' => '<b>quizofmine.com</b> 26 Temmuz 2020 tarihinde kurulmuştur. <br><br>
    Eğlence amaçlı kendiniz hakkında test oluşturabilmeniz için bir sistem ve ilişkiler hakkında uzman insanlar tarafından hazırlanmış makaleler içermektedir.',
    'cookiePolicy-content' => '<p>Son güncellenme: 30/10/2022</p>
    <p>
    Biz, MADD, olarak güvenliğinize önem veriyor ve bu Çerez Politikası ile siz
    ...
    göz atabilir ya da bizlerle info@quizofmine.com e-mail adresi üzerinden iletişime geçebilirsiniz.
    </p>',
    'termsOfUse-content' => "<p>Son güncellenme: 30/10/2022</p>
    <p>
    Sevgili ziyaretçimiz, lütfen quizofmine.com web sitemizi ziyaret etmeden önce işbu
    ...
    <p>
    quizofmine.com web sitesi MADD tarafından yönetilmekte olup, bundan sonra SİTE olarak anılacaktır.
    ...
    <p>
    MADD olarak, sunacağımız hizmetlerin kapsamını ve niteliğini, yasalar
    ...
    (bundan böyle ve daha sonra 'içerik' olarak anılacaktır) MADD olup,
    ...
    Bursa Adliyesi Mahkemeleri ve İcra Daireleri yetkilidir.
    </p>"
];
?>